...
function Icon({ name, size = 20 }) {
  const paths = { home: <path d="m3 10 9-7 9 7v10a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1Z" />, compass: <><circle cx="12" cy="12" r="9" /><path d="m15.5 8.5-2.4 4.1-4.2 2.4 2.4-4.2Z" /></>, bookmark: <path d="M6 3h12a1 1 0 0 1 1 1v17l-7-4-7 4V4a1 1 0 0 1 1-1Z" />, wallet: <><path d="M4 6h15a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h13" /><path d="M16 13h5" /></>, user: <><circle cx="12" cy="8" r="4" /><path d="M4 21c.8-4 3.4-6 8-6s7.2 2 8 6" /></>, chevron: <path d="m9 18 6-6-6-6" /> };
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">{paths[name]}</svg>;
}

const links = [{ href: "/", label: "Home", icon: "home" }, { href: "/discover", label: "Discover", icon: "compass" }, { href: "/watch-parties", label: "Watch Parties", icon: "compass" }, { href: "/history", label: "History", icon: "bookmark" }, { href: "/wallet", label: "Wallet", icon: "wallet" }, { href: "/admin", label: "Admin", icon: "user" }];
